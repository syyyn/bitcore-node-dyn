...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for dynamicd is necessary for this upgrade with the "reindex=1" dynamic.conf option. \n' +
                 'There are changes necessary in both dynamic.conf and bitcore-node.json. \n\n' +
